...
type IconProps = {
  className?: string;
  // FIX: Add optional 'solid' property to support solid-style icons.
  solid?: boolean;
  // FIX: Add style prop to allow inline styling of icons.
...
export const HomeIcon: React.FC<IconProps> = ({ className, solid = false, style }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} style={style} viewBox="0 0 24 24" fill={solid ? "currentColor" : "none"} stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
        <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" />
        {solid ? null : <polyline points="9 22 9 12 15 12 15 22" />}
    </svg>
);

export const OfferIcon: React.FC<IconProps> = ({ className, style }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} style={style} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
...
export const ReceiptIcon: React.FC<IconProps> = ({ className, style }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} style={style} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
// FIX: Added missing LocationMarkerIcon and ChevronDownIcon components.
